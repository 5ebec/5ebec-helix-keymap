...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_LGUI, KC_LALT, KC_BSPC, EISU,    KC_SPC,  KC_LBRC, KC_RBRC, KC_SPC,  KANA,    KC_ENT,  KC_RALT, KC_RGUI, ADJUST  \
      ),
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, _______, KC__VOLDOWN,KC__VOLUP,KC__MUTE,AG_NORM,               KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
      _______, _______, KC_BRMD, KC_BRMU, _______, AG_SWAP, RGB_TOG, RGB_MOD, RGB_VAD, RGB_VAI, RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, \
